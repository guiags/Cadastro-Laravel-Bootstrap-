            ...
            <div class="col-3">
                <div style="margin: 2%;">
                    <div class="card text-center ">
                        ...
                        <b>Item: {{$produto->nome_prod}}</b>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">Custo: {{$produto->custo_prod}}</li>
                            <li class="list-group-item">Preço: {{$produto->preco_prod}}</li>
                            <li class="list-group-item">Quantidade: {{$produto->quantidade_prod}}</li>
